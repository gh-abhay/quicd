...
use crate::connection::{Connection, ConnectionConfig, ConnectionIdGenerator, ConnectionIdManager, NewConnectionIdData, RandomConnectionIdGenerator};
...
impl QuicServer for DefaultQuicServer {
    ...
    fn issue_connection_ids(
        ...
        let manager = self.cid_managers.entry(connection_id.clone()).or_insert_with(|| {
