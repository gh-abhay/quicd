...
Learn more in the [Architecture](/docs/architecture/) guide.

## Getting Started

Ready to build with QuicD? Here's how to get started:

1. **[Install QuicD](/docs/getting-started/installation/)**: Build from source or use cargo install
2. **[Configure your server](/docs/getting-started/configuration/)**: Set up workers, buffers, and QUIC parameters
3. **[Run HTTP/3](/docs/usage/http3/)**: Start serving HTTP/3 traffic immediately
4. **[Build custom apps](/docs/building-apps/interface/)**: Implement your own QUIC-based protocols
...
- **Contributing**: See the [Contributing Guide](/docs/community/contributing/)

## Next Steps

- **New to QUIC?** Start with [Core Concepts](/docs/concepts/) to understand the fundamentals
- **Want to see code?** Check out [HTTP/3 Usage](/docs/usage/http3/) for a complete example
- **Building a custom protocol?** Jump to [Building Apps](/docs/building-apps/interface/)
