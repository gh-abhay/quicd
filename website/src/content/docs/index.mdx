...
hero:
  title: QuicD
  tagline: The Flexible QUIC Server for Modern Apps
  actions:
    - text: Get Started
...
<CardGrid>
  ...
  <Card title="🦀 Rust Safety" icon="shield">
...
<CardGrid>
  ...
  <Card title="🛠️ Build an App" icon="puzzle">
...
<div style="text-align: center; margin-top: 4rem; padding: 2rem; background: var(--sl-color-gray-6); border-radius: 0.5rem;">
  <h3>Ready to build?</h3>
  <p>Install QuicD and start serving QUIC traffic in minutes.</p>
  <a href="/getting-started/installation/" class="button">Get Started</a>
  <a href="https://github.com/gh-abhay/quicd" class="button button-secondary" style="margin-left: 1rem;">View Source</a>
</div>
