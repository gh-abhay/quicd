...
See [Configuration Reference](/docs/reference/configuration/) for detailed tuning.
...
- **Understand the interfaces**: See [Core Concepts](/docs/concepts/) for terminology
- **Configure your server**: Jump to [Configuration Guide](/docs/getting-started/configuration/)
- **Build an application**: Read [Building Apps](/docs/building-apps/interface/)
