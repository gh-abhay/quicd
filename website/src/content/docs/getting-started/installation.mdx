...
See [Configuration Guide](/docs/getting-started/configuration/) for full options.
...
1. **[Configure QuicD](/docs/getting-started/configuration/)**: Learn about all configuration options
2. **[Run HTTP/3 Server](/docs/usage/http3/)**: Serve HTTP/3 traffic immediately
3. **[Build Custom Apps](/docs/building-apps/interface/)**: Implement your own QUIC-based protocols
