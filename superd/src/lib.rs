...
impl Superd {
    ...
    pub fn new(config: Config) -> Result<Self, String> {
        ...
        log::info!(
            ...
            service_registry.list_services().len()
        );
    ...
    ///
    /// Returns a reference to the service registry for routing requests.
    ...
    pub fn start(&mut self) -> Result<(), String> {
        ...
        let mut placement = ThreadPlacement::new(self.config.network_io.cpu_affinity_strategy);
        ...
        log::info!(
            "║  Tokio workers: {}                                      ║",
            self.config.tokio_worker_count()
        );
        log::info!("║                                                           ║");
